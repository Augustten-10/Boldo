  ...
  return (
    <div className="px-24 py-10">
      <div className="flex justify-between px-24">
        <div className="leading-normal w-1/4">
          <Logo textColor="#0A2640" svgColor="#0A2640" />
          <p className="font-openSans mt-16">
            Social media validation business model canvas graphical user
            interface launch party creative facebook iPad twitter.
          </p>
          <p className="font-openSans mt-10">All rights reserved.</p>
        </div>
        <div className="flex gap-24">
          {tables.map((table) => (
            <div
              key={table.id}
              className="flex flex-col gap-7 text-xl leading-normal text-greyish"
            >
